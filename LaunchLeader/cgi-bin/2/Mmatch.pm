...
mmatch_id,account_id,mmatch_account_id,mmatch_score,mmatch_note,mmatch_made,mmatch_notified,mmatch_contacted,mmatch_expires,mmatch_type,mmatch_status
	...
	VALUES (
$mmatch->{'mmatch_id'},$mmatch->{'account_id'},$mmatch->{'mmatch_account_id'},$mmatch->{'mmatch_score'},$mmatch->{'mmatch_note'},NOW(),NOW(),NOW(),NOW(),$mmatch->{'mmatch_type'},$mmatch->{'mmatch_status'}
	)";
