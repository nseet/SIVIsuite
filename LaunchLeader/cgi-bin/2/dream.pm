...
{
   return "MY_ADMIN_ENCRYPTED_PASSWORD";
}
...
sub Connect
{
   my $database = "MY_DB_NAME" || shift || return undef;
   my $DB_HOST = "DATABASE.rackspaceclouddb.com";
  
   my $DB = "DBI:mysql:$database:$DB_HOST";
   my $DB_USERNAME = "MY_DB_USERNAME";
   my $DB_PASSWORD = "MY_DB_PASSWORD";
